...
class TitleChainApp(tk.Tk):
    ...
    def setup_main_menu(self):
        ...
        # Title frame to group the welcome label and subheading
        title_frame = ttk.Frame(self.main_frame)
        title_frame.grid(row=0, column=0, padx=20, pady=(40, 10), sticky="n")

        # Welcome label (main title)
        ...
        # Subheading directly under the title
        integration_label = ttk.Label(
            title_frame,
            text="A blockchain-based SoftPro integration.",
            font=("Helvetica", 16)
        )
        integration_label.pack(anchor="center")

        # Prompt label for main options
